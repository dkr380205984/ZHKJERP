        ...
        <div class="inputCtn">
          ...
          <div class="content">
            ...
            <ul class="checkCtn">
              ...
              <div class="proBox">
                <li v-for="(item,key) in checkedProList.filter(value=>value.checked)"
                  :key="key">
          ...
          <div class="content">
            <div class="listCtn">
              <div class="productBox"
                ...
                :key="key">
                <div class="box-top">
                  <img :src="item.img[0] ? item.img[0].img_url : require('@/assets/image/index/noPic.jpg')"
                    alt="">
                  <div class="info">
                    <span>产品描述:</span>
