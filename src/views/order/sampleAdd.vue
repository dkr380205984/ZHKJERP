<template>
  <div id="productCreate"
    ...
    <div class="body">
      ...
      <div class="inputCtn">
        <span class="label must">样品品类:</span>
      ...
      <div class="inputCtn"
        ...
        <span class="label must">样品成分:</span>
        <div class="cancleCtn"
          style="margin-left:15px"
          v-for="item in ingredientNum"
          :key="item">
          <div class="index">{{item}}</div>
          <el-select class="specialSel"
          ...
          <el-input style="width:160px;margin-left:15px;margin-bottom:24px"
            placeholder="请输入比例"
      ...
      <div class="inputCtn"
        ...
        <span class="label must">样品尺寸:</span>
        <div class="lineCtn"
          ...
          <el-input v-for="(item,index) in child_size"
            class="elInputAp"
            placeholder="请输入数字"
