    ...
    <div class="body">
      ...
      <div class="mergeTable">
        <div class="mergeHeader">
          ...
          <div class="tableColumn" style="flex:1.5">产品信息</div>
          ...
          <div class="tableColumn" style="flex:1.5">操作</div>
        </div>
        <div class="mergeBody" v-for="(item ,index) in list" :style="{'height':(item.lineNum*60)+'px'}" :key="index">
          ...
          <div class="tableColumn" style="flex:1.5">
          ...
          <div class="tableColumn" style="flex-direction:row;flex:1.5">
            <div style="margin:auto">
              ...
              <span class="btns normal">半成品加工</span>
            </div>
          </div>
        </div>
