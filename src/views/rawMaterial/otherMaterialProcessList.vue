<template>
  <div id="otherMaterialProcessList"
       v-loading="loading">
    <div class="head">
      <h2>辅料加工列表</h2>
        ...
        <div class="mergeBody"
          ...
          <div class="tableColumn"
            ...
            <span class="btns normal"
                  @click="$router.push('/index/otherMaterialProcess/'+1)">辅料加工</span>
          </div>
        </div>
      </div>
      <div class="pageCtn">
...
@import "~@/assets/css/otherMaterialProcessList.less";
</style>
<style lang="less">
#otherMaterialProcessList {
  .el-carousel__arrow {
    color: #fff;
    background: #1a95ff;
    &:hover {
