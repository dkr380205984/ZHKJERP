      ...
      <div class="stepCtn">
        ...
        <div class="lineCtn">
          <div class="inputCtn">
            ...
            <div class="updateBtn"
              @click="updateRate('rate1')">{{rate1Flag?'修改':'确认'}}</div>
          </div>
        </div>
        <div class="lineCtn">
          <div class="inputCtn">
        ...
        <div class="lineCtn"
          ...
          <div class="inputCtn oneLine rowLine">
            ...
            <div class="overflowCtn"
              style="padding-left:62px;position:relative"
              :style="{'overflow-x':longSort.length>12?'auto':'hidden'}">
              <!-- 左边加个假的表头 -->
              <div class="leftTitle">
                <div class="titleOnce"
                  style="line-height:39px;">列数</div>
                <div class="titleOnce"
                  style="line-height:51px;">主/夹</div>
                <div class="titleOnce"
                  style="line-height:51px;">长/宽</div>
                <div class="titleOnce"
                  style="line-height:46px;">根数</div>
                <div class="titleOnce"
                  style="line-height:33px;">合并项</div>
                <div class="titleOnce"
                  style="line-height:33px;">合并项</div>
              </div>
              <div class="selectCtn"
        ...
        <div class="lineCtn">
          <div class="inputCtn">
            ...
            <el-input class="elInput"
              placeholder="请输入数字"
              v-model="warp_data.xishu"></el-input>
          </div>
          <div class="inputCtn">
      ...
      <div class="stepCtn">
        ...
        <div class="lineCtn">
          <div class="inputCtn">
            ...
            <div class="updateBtn"
              @click="updateRate('rate2')">{{rate2Flag?'修改':'确认'}}</div>
          </div>
        </div>
        <div class="lineCtn">
          <div class="inputCtn">
...
<script>
import { craftOne, YarnList, editList, saveCraft, YarnColorList, craftList } from '@/assets/js/api.js'
